...
- **Peak and sustained brightness as delivered.** Panel capability sets a ceiling; the brand's power delivery, thermal design and luminance limiter decide what you get. Check the [DisplayHDR True Black tier](/hdr/displayhdr-tiers-explained/), which is measured on the finished product.
...
- **Motion handling and overdrive tuning.** See [why the response time on the box isn't what you think](/motion/monitor-response-time-1ms-explained/).
...
*Specifications and warranty terms current as of 12 August 2026; warranty coverage varies by model, region and purchase date, and manufacturers revise it without notice. PanelProof does not measure displays — subpixel and fringing characterisations here are drawn from the cited published analyses.*
